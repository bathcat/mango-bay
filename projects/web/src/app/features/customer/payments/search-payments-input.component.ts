...
@Component({
  selector: 'mbc-search-payments-input',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
    ...
    <div class="mbc-search-container">
      <div class="mbc-search-input-wrapper">
        <input
          ...
          placeholder="Search by cardholder names (comma separated)"
...
export class SearchPaymentsInputComponent {
